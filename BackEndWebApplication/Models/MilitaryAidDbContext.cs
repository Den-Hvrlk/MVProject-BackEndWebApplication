...
public partial class MilitaryAidDbContext : DbContext
{
    public MilitaryAidDbContext()
    {
    }

    public MilitaryAidDbContext(DbContextOptions<MilitaryAidDbContext> options)
        : base(options)
    {
    }
